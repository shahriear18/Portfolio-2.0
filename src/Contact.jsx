  ...
  return (
    <>
      <div className=" container edusa">
        ...
        <div className="pb-20 lg:flex justify-around mt-[50px]">
          <div className=" lg:h-[300px]">
            <h2 className="text-center text-[23px] mb-[20px] mt-[20px]">
              My <span>contact's</span>
            </h2>
            <ul className=" grid gap-3 mt-[0px] mb-[20px] justify-center">
            ...
            <div className=" contact lg:ml-[50px] lg:w-[500px] ">
          ...
          <div className="lg:mt-[0px] mt-[50px]">
            <form>
              <div className="">
                <input
                  type="text"
